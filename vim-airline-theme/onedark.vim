...
function! airline#themes#onedark#refresh()
  ...
  let s:I1 = [ s:colors.black.gui, s:colors.blue.gui, 254, 237 ]
  let s:I2 = s:N2
  ...
  let s:R1 = [ s:colors.black.gui, s:colors.red.gui, 254, 237 ]
  let s:R2 = s:N2
  ...
  let s:V1 = [ s:colors.black.gui, s:colors.purple.gui, 254, 237 ]
  let s:V2 = s:N2
