...
function! airline#themes#onedark#refresh()
  ...
  let s:I1 = [ s:colors.black.gui, s:colors.blue.gui, 254, 241 ]
  let s:I2 = s:N2
  let s:I3 = [ s:colors.blue.gui, s:colors.black.gui, s:term_blue, '' ]
  let s:I4 = s:I3
  let s:I5 = s:N2
  let s:I6 = [ s:colors.black.gui, s:colors.blue.gui, 254, 237 ]
  let g:airline#themes#onedark#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3, s:I4, s:I5, s:I6)
  let g:airline#themes#onedark#palette.insert_modified = g:airline#themes#onedark#palette.normal_modified

  let s:R1 = [ s:colors.black.gui, s:colors.red.gui, 254, 241 ]
  let s:R2 = s:N2
  let s:R3 = [ s:colors.red.gui, s:colors.black.gui, s:term_red, '' ]
  let s:R4 = s:R3
  let s:R5 = s:N2
  let s:R6 = [ s:colors.black.gui, s:colors.blue.gui, 254, 237 ]
  let g:airline#themes#onedark#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3, s:R4, s:R5, s:R6)
  let g:airline#themes#onedark#palette.replace_modified = g:airline#themes#onedark#palette.normal_modified

  let s:V1 = [ s:colors.black.gui, s:colors.purple.gui, 254, 241 ]
  let s:V2 = s:N2
  let s:V3 = [ s:colors.purple.gui, s:colors.black.gui, s:term_purple, '' ]
  let s:V4 = s:V3
  let s:V5 = s:N2
  let s:V6 = [ s:colors.black.gui, s:colors.blue.gui, 254, 237 ]
  ...
  " Warnings
  let s:WI = [ s:colors.black.gui, s:colors.yellow.gui, s:term_black, 215 ]
